...
cmd({
  ...
  try {
    ...
    _0x82e9b2("🎨 *\`Avishka_X MD RANDOM COLOUR:\`* \n\nColour Name: " + _0x5d0cef + "\nCode: " + _0x256030);
  } catch (_0x563257) {
...
cmd({
  ...
  try {
    ...
    _0x20adfd(" *\`Avishka_X-MD Binary Representation:\`* \n\n" + _0x63c851);
  } catch (_0x307dbc) {
...
cmd({
  ...
  try {
    ...
    _0x1fc9a9("*\`Avishka_X-MD Decoded Text:\`* \n\n" + _0x26dbbd);
  } catch (_0xbe47d3) {
...
cmd({
  ...
  try {
    ...
    _0xe552ef("*\`Avishka_X-MD Decoded Text:\`* \n\n" + _0x529359);
  } catch (_0x28b6de) {
